...
pub struct SimulatedEndpoint {
    /// Controller configuration used for this endpoint.
...
pub struct SimulationConfig {
    /// Amount of simulated time during which new requests arrive.
    pub duration: Duration,
    /// Total offered request rate across all endpoints, in requests per second.
    pub offered_rate: f64,
    /// Endpoints available to the simulated P2C balancer.
    pub endpoints: Vec<SimulatedEndpoint>,
    /// Seed used for reproducible P2C choices and controller probes.
    pub seed: u64,
}
...
pub struct SimulationReport {
    /// Total number of requests generated by the offered workload.
    pub offered: u64,
    /// Number of requests accepted into an endpoint's scheduling horizon.
    pub accepted: u64,
    /// Number of requests rejected because no endpoint could accept them.
    pub backpressured: u64,
    /// Number of accepted requests dispatched to endpoint workers.
    pub dispatched: u64,
    /// Number of dispatched requests completed within the simulation window.
    pub completed: u64,
    /// Largest per-endpoint virtual queue depth observed.
    pub max_queued: usize,
    /// Final report for each configured endpoint, in input order.
...
pub struct EndpointReport {
    /// Number of requests dispatched to this endpoint.
    pub dispatched: u64,
    /// Number of this endpoint's requests completed within the time window.
    pub completed: u64,
    /// Controller state at the end of the simulation window.
